...
class MainModel:
    ...
    def __init__(self, stage_1_1, stage_1_2, stage_2):
    ...
    def process_preds_1(self, pred_1_1, pred_1_2):

        # concatenate predictions
        preds_1 = np.concatenate([pred_1_1, pred_1_2], axis=-1)

        # pad stage 2 inputs 
        input_stage_2 = np.zeros((self.n_timesteps, 18))
    ...
    def predict(self, input_data):
        ...
        input_2 = self.process_preds_1(pred_1_1, pred_1_2)
